...
}, $f = assign($f, [Complex("0").add(Complex("2"))], Complex("8"), 0)), $f = assign($f, [Complex("1").add(Complex("3"))], Complex("1000"), 0)), write($f(Complex("0")))), write($f(Complex("2")))), write($f(Complex("4")));
